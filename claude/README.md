...
Run `setup.sh` from the repo root to configure everything automatically. The statusline command will be
set to point directly at `claude/statusline.sh` in this repo — no manual symlinking needed.
